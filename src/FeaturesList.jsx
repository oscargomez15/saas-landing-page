...
export const Features = () => {
  return (
    <section className='flex flex-col lg:w-6/12 w-10/12 mx-auto min-h-dvh gap-36 justify-center items-center mt-64'>
        ...
        <div className='features flex gap-16 flex-wrap justify-around'>
            <article className='bg-[#374357] md:basis-1/3 rounded-3xl flex items-center justify-center shadow-2xl h-48'>
